...
module Sequel::Dataset::Replace
  def insert_insert_sql(sql); end
  def multi_replace(*values); end
  def replace(*values); end
  def replace_sql(*values); end
  def supports_replace?; end
end
...
module Sequel::SQLite::DatabaseMethods
  def alter_table_sql(table, op); end
  def apply_alter_table(table, ops); end
  def auto_vacuum; end
  def auto_vacuum=(value); end
  def backup_table_name(table, opts = nil); end
  def begin_new_transaction(conn, opts); end
  def can_add_primary_key_constraint_on_nullable_columns?; end
  def case_sensitive_like=(value); end
  def column_definition_default_sql(sql, column); end
  def connection_pragmas; end
  def create_view_prefix_sql(name, options); end
  def database_error_regexps; end
  def database_specific_error_class(exception, opts); end
  def database_type; end
  def defined_columns_for(table); end
  def duplicate_table(table, opts = nil); end
  def foreign_key_list(table, opts = nil); end
  def foreign_keys; end
  def foreign_keys=(value); end
  def freeze; end
  def indexes(table, opts = nil); end
  def integer_booleans; end
  def integer_booleans=(arg0); end
  def on_delete_sql_to_sym(str); end
  def parse_pragma(table_name, opts); end
  def pragma_get(name); end
  def pragma_set(name, value); end
  def schema_parse_table(table_name, opts); end
  def set_integer_booleans; end
  def sqlite_error_code(exception); end
  ...
  def supports_savepoints?; end
  def synchronous; end
  def synchronous=(value); end
  def tables(opts = nil); end
  def tables_and_views(filter, opts); end
  def temp_store; end
  def temp_store=(value); end
  def transaction_mode; end
  def transaction_mode=(value); end
  def type_literal_generic_bignum_symbol(column); end
  def use_timestamp_timezones=(arg0); end
  def use_timestamp_timezones?; end
  def values(v); end
...
module Sequel::SQLite::DatasetMethods
  ...
  def _truncate_sql(table); end
  def _update_sql; end
  def alias_qualified_column(col); end
  def as_sql_append(sql, aliaz, column_aliases = nil); end
  def cast_sql_append(sql, expr, type); end
  def complex_expression_sql_append(sql, op, args); end
  def constant_sql_append(sql, constant); end
  ...
  def having(*cond); end
  def identifier_list(columns); end
  def insert_conflict(resolution = nil); end
  ...
  def multi_insert_sql_strategy; end
  def native_function_name(emulated_function); end
  def quoted_identifier_append(sql, c); end
  def select(*cols); end
  def select_lock_sql(sql); end
  def select_only_offset_sql(sql); end
  def select_sql; end
...
class Sequel::SQLite::Database < Sequel::Database
  def _execute(type, sql, opts, &block); end
  def adapter_initialize; end
  ...
  def database_error_classes; end
  def dataset_class_default; end
  def disconnect_connection(c); end
  def execute(sql, opts = nil, &block); end
  def execute_ddl(sql, opts = nil); end
  def execute_dui(sql, opts = nil); end
  def execute_insert(sql, opts = nil); end
  def execute_prepared_statement(conn, type, name, opts, &block); end
  def freeze; end
  def prepared_statement_argument(arg); end
  def self.uri_to_options(uri); end
  def to_application_timestamp(s); end
  include Sequel::SQLite::DatabaseMethods
end
class Sequel::SQLite::Dataset < Sequel::Dataset
  def base_type_name(t); end
  def bound_variable_modules; end
...
module Sequel::SQLite::Dataset::BindArgumentMethods
  ...
  def execute_dui(sql, opts = nil); end
  def execute_insert(sql, opts = nil); end
  include Sequel::SQLite::Dataset::ArgumentMapper
end
module Sequel::SQLite::Dataset::PreparedStatementMethods
  def execute(sql, opts = nil); end
  def execute_dui(sql, opts = nil); end
  def execute_insert(sql, opts = nil); end
  include Sequel::SQLite::Dataset::BindArgumentMethods
end
